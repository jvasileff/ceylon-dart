...
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_ANNOTATIONS;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_ATTRIBUTES;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_CLASSES;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_CONSTRUCTOR;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_CONSTRUCTORS;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_DEFAULT;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_DS_VARIANCE;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_DYNAMIC;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_FLAGS;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_INTERFACES;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_METATYPE;
...
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_TYPE_PARAMS;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.KEY_US_VARIANCE;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_ALIAS;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_ATTRIBUTE;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_CLASS;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_GETTER;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_INTERFACE;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_METHOD;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.METATYPE_OBJECT;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.annotationBits;
import static com.vasileff.ceylon.dart.compiler.loader.MetamodelGenerator.partiallyQualifiedName;
...
public class JsonPackage extends LazyPackage {
    ...
    Declaration load(String name, List<TypeParameter> existing) {
        // TODO submit upstream patch (originally commit 5655d4ec)
