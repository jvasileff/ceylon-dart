native("jvm")
module com.vasileff.ceylon.dart.compiler "1.2.1-DP2-SNAPSHOT" {
    ...
    import com.vasileff.jl4c.guava "0.0.3-SNAPSHOT";
    import com.redhat.ceylon.model "1.2.2";
    import com.redhat.ceylon.compiler.js "1.2.2";
