native("jvm")
module com.vasileff.ceylon.dart.compiler "1.3.3-DP5-SNAPSHOT" {
    ...
    shared import ceylon.json "1.3.3-SNAPSHOT";
    ...
    import com.vasileff.ceylon.structures "1.1.3-SNAPSHOT";

    import com.redhat.ceylon.cli "1.3.3-SNAPSHOT";
